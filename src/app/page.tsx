    ...
    <div className="space-y-16 py-8">
      <div className="text-center max-w-3xl mx-auto space-y-6 animate-fade-in">
        ...
        <div className="flex justify-center space-x-4 pt-2">
          ...
          <Link href="/courses" className="px-6 py-3 font-semibold text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-800 border border-slate-200 rounded-xl shadow-sm transition-all">
            {t.startLearning}
          </Link>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center bg-white dark:bg-slate-800 p-8 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-sm">
        <div>
          <h2 className="text-2xl font-bold mb-6">{t.whyMentoria}</h2>
          <ul className="space-y-5">
            <li className="flex items-start bg-slate-50 dark:bg-slate-900/50 p-4 rounded-xl">
              <span className="text-indigo-600 font-bold mr-3 text-lg">✓</span>
              <div>
